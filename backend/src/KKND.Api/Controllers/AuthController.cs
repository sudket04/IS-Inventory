...
{
    private const string RefreshCookieName = "kknd_refresh";

    private readonly IAuthService _authService;
    private readonly KkndDbContext _db;
    private readonly IPasswordHasher _passwordHasher;

    public AuthController(IAuthService authService, KkndDbContext db, IPasswordHasher passwordHasher)
    {
    ...
    public async Task<IActionResult> ChangePassword([FromBody] ChangePasswordRequest request, CancellationToken ct)
    {
        ...
        _db.AuditLogs.Add(new KKND.Infrastructure.Entities.AuditLog
        {
            UserId = userId,
