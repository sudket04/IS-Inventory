...
using FileShare = KKND.Infrastructure.Entities.FileShare;

namespace KKND.Infrastructure;

public partial class KkndDbContext : DbContext
{
    public KkndDbContext(DbContextOptions<KkndDbContext> options)
        : base(options)
    {
    }
